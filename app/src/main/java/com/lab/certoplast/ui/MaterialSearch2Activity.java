...
public class MaterialSearch2Activity extends BaseActivity {
    ...
    private void initialView(){
        ...
        tv_h2.setText("托盘电子标签ID");
        SpannableString s = new SpannableString("托盘电子标签ID");//这里输入自己想要的提示文字
        et_search.setHint(s);
        btn_commit.setText("绑定");
...
//                break;
            ...
            case R.id.tv_logout:
                ...
                redictToActivity(MaterialSearch2Activity.this, LoginActivity.class, null);
                break;
            case R.id.tv_main:
                AppManager.getAppManager().finishAllActivity();
                redictToActivity(MaterialSearch2Activity.this, MainActivity.class, null);
                break;
        }
    }
    ...
    private void commit(){
        ...
        //Pallet_ID, ruku_ID, Product_PID

        String Pallet_ID = et_search.getText().toString().trim();
        if (TextUtils.isEmpty(Pallet_ID)){
            UiCommon.INSTANCE.showTip("请输入托盘电子标签!");
            return;
        }
        ...
        String ruku_ID = migo.getRuku_id();
        String Product_PID = migo.getPid();

        RequestVo vo = new RequestVo();

        HashMap<String, String> map = new HashMap<>();
        map.put("Pallet_ID", Pallet_ID);
        map.put("ruku_ID", ruku_ID);
        map.put("Product_PID", Product_PID);


          vo.methodName = "tag.asp";
        vo.requestDataMap = map;
            ...
            public void processData(Object paramObject, boolean paramBoolean) {
                ...
                if (paramObject == null){
                    ...
                    if ("success".equals(response.getResponse())){
                        UiCommon.INSTANCE.showTip("绑定标签成功!");
...
//        final AlertDialog myDialog = new AlertDialog.Builder(MaterialSearch2Activity.this)
//                .create();
//        myDialog.show();
//        WindowManager windowManager = MaterialSearch2Activity.this.getWindowManager();
...
//
//
//        final ShowWareHouseAdapter showWareHouseAdapter = new ShowWareHouseAdapter(MaterialSearch2Activity.this, areas);
