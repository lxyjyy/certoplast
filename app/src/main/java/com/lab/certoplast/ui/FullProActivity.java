...
public class FullProActivity extends BaseActivity {
    ...
    protected View initView() {
        return LayoutInflater.from(this).inflate(R.layout.activity_fullpro, null, false);
    }
    ...
    private void search(){
        ...
        if (TextUtils.isEmpty(search)){
            UiCommon.INSTANCE.showTip("请输入待入库成品批号");
            return;
        }
        ...
        redictToActivity(this, FullProDetail1Activity.class, bundle);
