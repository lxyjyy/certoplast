...
public class MigoSearch1Activity extends BaseActivity {
...
//        initialData();
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id.tv_logout:
                ...
                redictToActivity(MigoSearch1Activity.this, LoginActivity.class, null);
                break;
            case R.id.tv_main:
                AppManager.getAppManager().finishAllActivity();
                redictToActivity(MigoSearch1Activity.this, MainActivity.class, null);
                break;
        }
    ...
    private void jumpToNext(){
        ...
        redictToActivity(MigoSearch1Activity.this, MigoSearch2Activity.class, bundle);
    }
