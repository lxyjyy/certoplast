...
public class BaseContentAdapter<T> extends BaseAdapter {
	...
	public BaseContentAdapter(Context context, T[] objects) {
		init(context, Arrays.asList(objects));
	}

	public BaseContentAdapter(Context context, List<T> objects) {
